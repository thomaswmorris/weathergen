...
Supported sites are shown below. Sites are chosen for the presence of major astronomical observatories, or because they are climatological outliers (and thus a good test of my model). 
